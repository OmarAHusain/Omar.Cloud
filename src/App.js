  ...
  return (
    <div class="background">
      <div class="center-div container">
        ...
        <hr />
        <h3 class="link-title">Projects</h3>
        ...
        />
        <hr />
        <h3 class="link-title">Socials</h3>
        <div class="justify-content-center row">

          <div class="socials justify-content-center row"> 
            <SocialButton 
            ...
            <SocialButton 
              name="Youtube"
              link="https://www.youtube.com/channel/UCxt0uBqVhnRv4VfaUsNII7Q"
